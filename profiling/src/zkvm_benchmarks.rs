...
impl ZkvmBenchmarkSuite {
    ...
    pub fn benchmark_risc0_email_verification(&mut self, email: &Email) -> Result<(), Box<dyn std::error::Error>> {
    ...
    pub fn benchmark_sp1_email_verification(&mut self, email: &Email) -> Result<(), Box<dyn std::error::Error>> {
        use std::time::Instant;
    ...
    pub fn benchmark_email_with_regex(&mut self, _email_with_regex: &EmailWithRegex) -> Result<(), Box<dyn std::error::Error>> {        #[cfg(feature = "risc0")]
    ...
    #[cfg(feature = "risc0")]
    fn benchmark_risc0_email_with_regex(&mut self, email_with_regex: &EmailWithRegex) -> Result<(), Box<dyn std::error::Error>> {
        use std::time::Instant;
    ...
    #[cfg(feature = "sp1")]
    fn benchmark_sp1_email_with_regex(&mut self, email_with_regex: &EmailWithRegex) -> Result<(), Box<dyn std::error::Error>> {
        use std::time::Instant;
...
fn estimate_memory_usage(email: &Email) -> u64 {
    ...
    let external_inputs_size = email.external_inputs.iter()
